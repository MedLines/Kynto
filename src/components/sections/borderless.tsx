  ...
  return (
    <section className="relative w-full pt-24 pb-64 bg-black overflow-hidden min-h-[800px] flex flex-col items-center justify-start">
      ...
      <motion.div
        ...
        className="relative z-20 w-full max-w-7xl px-4 flex flex-col items-center text-center mt-12 md:mt-20"
      >
        <motion.div
          variants={{
        ...
        <motion.h2
          ...
          className="text-3xl md:text-4xl lg:text-5xl leading-[1.1] tracking-tight text-white mb-12 font-poppins"
        >
