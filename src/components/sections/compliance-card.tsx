...
export function ComplianceCard({ constraintsRef }: ComplianceCardProps) {
  return (
    <motion.div
      ...
      className="absolute bottom-40 right-10 w-auto h-[100px] rounded-[24px] bg-card-black/10 backdrop-blur-md border border-white/5 p-4 flex items-center gap-4 shadow-2xl z-50 cursor-grab active:cursor-grabbing overflow-hidden group"
    >
      {/* Icon Circle */}
